...
public class PiecesThreeFromEdgeHeuristic implements Heuristic{
    @Override
    public double score(Board board, BoardElement element) {
        ...
        eligiblePositions.add(new Position(0, 2));
        eligiblePositions.add(new Position(2, 0));

        eligiblePositions.add(new Position(5, 0));
        eligiblePositions.add(new Position(7, 2));

        eligiblePositions.add(new Position(0, 5));
        eligiblePositions.add(new Position(2, 7));

        eligiblePositions.add(new Position(5, 7));
        eligiblePositions.add(new Position(7, 5));
